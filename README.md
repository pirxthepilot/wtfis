...
As above, IP2Whois is recommended over Virustotal.
...
If supported by the terminal, the `Analysis` field in the whois panel are clickable hyperlinks that point to the appropriate pages on the VT website.
